...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FilterAction_t, stringdata) + ofs \
...
const QMetaObject FilterAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_FilterAction.data,
      qt_meta_data_FilterAction,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FilterAction.stringdata))
        return static_cast<void*>(const_cast< FilterAction*>(this));
