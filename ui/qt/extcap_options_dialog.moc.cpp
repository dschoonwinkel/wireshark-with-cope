...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ExtcapOptionsDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 110, 26),
QT_MOC_LITERAL(8, 137, 13),
...
const QMetaObject ExtcapOptionsDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ExtcapOptionsDialog.data,
      qt_meta_data_ExtcapOptionsDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ExtcapOptionsDialog.stringdata))
        return static_cast<void*>(const_cast< ExtcapOptionsDialog*>(this));
