...
public:
    ...
    void setupUi(QDialog *SequenceDialog)
    {
        ...
        showComboBox = new QComboBox(controlFrame);
        showComboBox->setObjectName(QStringLiteral("showComboBox"));

        horizontalLayout_2->addWidget(showComboBox);
...
"</body></"
        ...
        label->setText(QApplication::translate("SequenceDialog", "Show:", 0));
        showComboBox->clear();
        showComboBox->insertItems(0, QStringList()
         << QApplication::translate("SequenceDialog", "All packets", 0)
         << QApplication::translate("SequenceDialog", "Displayed packets", 0)
        );
