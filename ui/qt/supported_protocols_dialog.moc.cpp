...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SupportedProtocolsDialog_t, stringdata) + ofs \
...
const QMetaObject SupportedProtocolsDialog::staticMetaObject = {
    { &GeometryStateDialog::staticMetaObject, qt_meta_stringdata_SupportedProtocolsDialog.data,
      qt_meta_data_SupportedProtocolsDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SupportedProtocolsDialog.stringdata))
        return static_cast<void*>(const_cast< SupportedProtocolsDialog*>(this));
