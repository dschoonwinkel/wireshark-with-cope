...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ServiceResponseTimeDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 36, 26)
    ...
    "ServiceResponseTimeDialog\0fillTree\0\0"
    "statsTreeWidgetItemChanged\0"
};
...
void ServiceResponseTimeDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->statsTreeWidgetItemChanged(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ServiceResponseTimeDialog::staticMetaObject = {
    { &TapParameterDialog::staticMetaObject, qt_meta_stringdata_ServiceResponseTimeDialog.data,
      qt_meta_data_ServiceResponseTimeDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ServiceResponseTimeDialog.stringdata))
        return static_cast<void*>(const_cast< ServiceResponseTimeDialog*>(this));
