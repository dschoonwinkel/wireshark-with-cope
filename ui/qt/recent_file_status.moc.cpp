...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RecentFileStatus_t, stringdata) + ofs \
...
void RecentFileStatus::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (RecentFileStatus::*_t)(const QString , qint64 , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RecentFileStatus::statusFound)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject RecentFileStatus::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_RecentFileStatus.data,
      qt_meta_data_RecentFileStatus,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RecentFileStatus.stringdata))
        return static_cast<void*>(const_cast< RecentFileStatus*>(this));
