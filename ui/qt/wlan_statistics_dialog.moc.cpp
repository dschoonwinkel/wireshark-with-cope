...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WlanStatisticsDialog_t, stringdata) + ofs \
...
const QMetaObject WlanStatisticsDialog::staticMetaObject = {
    { &TapParameterDialog::staticMetaObject, qt_meta_stringdata_WlanStatisticsDialog.data,
      qt_meta_data_WlanStatisticsDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WlanStatisticsDialog.stringdata))
        return static_cast<void*>(const_cast< WlanStatisticsDialog*>(this));
