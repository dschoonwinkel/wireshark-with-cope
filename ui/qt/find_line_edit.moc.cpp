...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FindLineEdit_t, stringdata) + ofs \
...
void FindLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FindLineEdit::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FindLineEdit::useRegexFind)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject FindLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_FindLineEdit.data,
      qt_meta_data_FindLineEdit,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FindLineEdit.stringdata))
        return static_cast<void*>(const_cast< FindLineEdit*>(this));
