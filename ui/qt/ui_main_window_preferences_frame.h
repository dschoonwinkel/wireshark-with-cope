...
public:
    ...
    QLabel *autoScrollPercentageLabel;
    QLineEdit *autoScrollPercentageLineEdit;
    ...
    void setupUi(QFrame *MainWindowPreferencesFrame)
    {
        ...
        autoScrollCheckBox = new QCheckBox(MainWindowPreferencesFrame);
        autoScrollCheckBox->setObjectName(QStringLiteral("autoScrollCheckBox"));

        verticalLayout->addWidget(autoScrollCheckBox);

        horizontalLayout_4 = new QHBoxLayout();
        horizontalLayout_4->setObjectName(QStringLiteral("horizontalLayout_4"));
        autoScrollPercentageLabel = new QLabel(MainWindowPreferencesFrame);
        autoScrollPercentageLabel->setObjectName(QStringLiteral("autoScrollPercentageLabel"));

        horizontalLayout_4->addWidget(autoScrollPercentageLabel);

        autoScrollPercentageLineEdit = new QLineEdit(MainWindowPreferencesFrame);
        autoScrollPercentageLineEdit->setObjectName(QStringLiteral("autoScrollPercentageLineEdit"));

        horizontalLayout_4->addWidget(autoScrollPercentageLineEdit);
...
#ifndef QT_NO_TOOLTIP
        autoScrollCheckBox->setToolTip(QApplication::translate("MainWindowPreferencesFrame", "If checked the packet detail items will be automatically scrolled when they are expanded.", 0));
#endif // QT_NO_TOOLTIP
        autoScrollCheckBox->setText(QApplication::translate("MainWindowPreferencesFrame", "Automatically scroll packet details", 0));
#ifndef QT_NO_TOOLTIP
        autoScrollPercentageLabel->setToolTip(QApplication::translate("MainWindowPreferencesFrame", "Percentage distance from the top to scroll packet details.", 0));
#endif // QT_NO_TOOLTIP
        autoScrollPercentageLabel->setText(QApplication::translate("MainWindowPreferencesFrame", "Packet detail scroll percentage:", 0));
#ifndef QT_NO_TOOLTIP
        autoScrollPercentageLineEdit->setToolTip(QApplication::translate("MainWindowPreferencesFrame", "Percentage distance from the top to scroll packet details.", 0));
#endif // QT_NO_TOOLTIP
