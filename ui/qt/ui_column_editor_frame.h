...
public:
    ...
    QLabel *label_3;
    SyntaxLineEdit *fieldsNameLineEdit;
    ...
    void setupUi(AccordionFrame *ColumnEditorFrame)
    {
        ...
        fieldsNameLineEdit = new SyntaxLineEdit(ColumnEditorFrame);
        ...
        horizontalSpacer = new QSpacerItem(59, 5, QSizePolicy::Expanding, QSizePolicy::Minimum);
