...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StockIconToolButton_t, stringdata) + ofs \
...
const QMetaObject StockIconToolButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_StockIconToolButton.data,
      qt_meta_data_StockIconToolButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StockIconToolButton.stringdata))
