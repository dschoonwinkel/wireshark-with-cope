...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FollowStreamText_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 49, 32)
    },
    "FollowStreamText\0mouseMovedToTextCursorPosition\0"
    "\0mouseClickedOnTextCursorPosition\0"
};
...
void FollowStreamText::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FollowStreamText::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FollowStreamText::mouseMovedToTextCursorPosition)) {
                *result = 0;
            }
        }
        {
            typedef void (FollowStreamText::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FollowStreamText::mouseClickedOnTextCursorPosition)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject FollowStreamText::staticMetaObject = {
    { &QPlainTextEdit::staticMetaObject, qt_meta_stringdata_FollowStreamText.data,
      qt_meta_data_FollowStreamText,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FollowStreamText.stringdata))
        return static_cast<void*>(const_cast< FollowStreamText*>(this));
