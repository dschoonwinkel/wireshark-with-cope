...
#ifndef QT_NO_TOOLTIP
        deleteToolButton->setToolTip(QApplication::translate("ProfileDialog", "Remove this profile. The Default profile and system provided profiles cannot be removed.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
