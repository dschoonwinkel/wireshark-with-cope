...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ResponseTimeDelayDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 33, 0)
    ...
    "ResponseTimeDelayDialog\0fillTree\0\0"
};
...
const QMetaObject ResponseTimeDelayDialog::staticMetaObject = {
    { &TapParameterDialog::staticMetaObject, qt_meta_stringdata_ResponseTimeDelayDialog.data,
      qt_meta_data_ResponseTimeDelayDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ResponseTimeDelayDialog.stringdata))
        return static_cast<void*>(const_cast< ResponseTimeDelayDialog*>(this));
