...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ExportDissectionDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 73, 26)
    },
    "ExportDissectionDialog\0exec\0\0"
    "exportTypeChanged\0name_filter\0"
    "checkValidity\0on_buttonBox_helpRequested\0"
};
...
const QMetaObject ExportDissectionDialog::staticMetaObject = {
    { &QFileDialog::staticMetaObject, qt_meta_stringdata_ExportDissectionDialog.data,
      qt_meta_data_ExportDissectionDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ExportDissectionDialog.stringdata))
        return static_cast<void*>(const_cast< ExportDissectionDialog*>(this));
