...
public:
    ...
    void retranslateUi(QDialog *CaptureInterfacesDialog)
    {
        ...
        rbPcapng->setText(QApplication::translate("CaptureInterfacesDialog", "pcap-ng", 0));
...
#endif // QT_NO_TOOLTIP
        cbExtraCaptureInfo->setText(QApplication::translate("CaptureInterfacesDialog", "Show extra capture information dialog", 0));
