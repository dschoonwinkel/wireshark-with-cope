...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SCTPGraphByteDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(11, 142, 21)
    ...
    "_capture_file*\0cf\0on_pushButton_4_clicked\0"
...
const QMetaObject SCTPGraphByteDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SCTPGraphByteDialog.data,
      qt_meta_data_SCTPGraphByteDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SCTPGraphByteDialog.stringdata))
        return static_cast<void*>(const_cast< SCTPGraphByteDialog*>(this));
