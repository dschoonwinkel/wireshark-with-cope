...
public:
    ...
    void setupUi(QDialog *EnabledProtocolsDialog)
    {
        ...
        protocol_tree_ = new QTreeWidget(EnabledProtocolsDialog);
        new QTreeWidgetItem(protocol_tree_);
    ...
    void retranslateUi(QDialog *EnabledProtocolsDialog)
    {
        ...
        QTreeWidgetItem *___qtreewidgetitem = protocol_tree_->headerItem();
        ___qtreewidgetitem->setText(1, QApplication::translate("EnabledProtocolsDialog", "Description", 0));
        ___qtreewidgetitem->setText(0, QApplication::translate("EnabledProtocolsDialog", "Protocol", 0));

        const bool __sortingEnabled = protocol_tree_->isSortingEnabled();
        protocol_tree_->setSortingEnabled(false);
        protocol_tree_->setSortingEnabled(__sortingEnabled);
