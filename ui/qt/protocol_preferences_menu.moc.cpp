...
void ProtocolPreferencesMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ProtocolPreferencesMenu::*_t)(const QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProtocolPreferencesMenu::showProtocolPreferences)) {
                *result = 0;
            }
        }
        {
            typedef void (ProtocolPreferencesMenu::*_t)(preference * , pref_module * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProtocolPreferencesMenu::editProtocolPreference)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ProtocolPreferencesMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_ProtocolPreferencesMenu.data,
      qt_meta_data_ProtocolPreferencesMenu,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ProtocolPreferencesMenu.stringdata))
        return static_cast<void*>(const_cast< ProtocolPreferencesMenu*>(this));
