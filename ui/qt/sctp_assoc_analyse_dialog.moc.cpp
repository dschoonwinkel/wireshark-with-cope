...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SCTPAssocAnalyseDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 84, 2),
QT_MOC_LITERAL(8, 87, 21),
QT_MOC_LITERAL(9, 109, 21),
QT_MOC_LITERAL(10, 131, 32),
QT_MOC_LITERAL(11, 164, 26),
QT_MOC_LITERAL(12, 191, 23),
QT_MOC_LITERAL(13, 215, 23),
QT_MOC_LITERAL(14, 239, 23),
QT_MOC_LITERAL(15, 263, 23)
    },
    ...
    "on_GraphArwnd_1_clicked\0on_GraphArwnd_2_clicked\0"
};
...
void SCTPAssocAnalyseDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SCTPAssocAnalyseDialog::*_t)(QString , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SCTPAssocAnalyseDialog::filterPackets)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject SCTPAssocAnalyseDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SCTPAssocAnalyseDialog.data,
      qt_meta_data_SCTPAssocAnalyseDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SCTPAssocAnalyseDialog.stringdata))
        return static_cast<void*>(const_cast< SCTPAssocAnalyseDialog*>(this));
