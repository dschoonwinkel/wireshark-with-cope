...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ProgressFrame_t, stringdata) + ofs \
...
QT_MOC_LITERAL(12, 136, 12),
QT_MOC_LITERAL(13, 149, 8),
QT_MOC_LITERAL(14, 158, 8),
QT_MOC_LITERAL(15, 167, 8),
QT_MOC_LITERAL(16, 176, 4),
QT_MOC_LITERAL(17, 181, 21),
QT_MOC_LITERAL(18, 203, 4),
QT_MOC_LITERAL(19, 208, 15)
    },
    ...
    "on_stopButton_clicked\0show\0setMaximumValue\0"
};
...
void ProgressFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: { progdlg* _r = _t->showProgress((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2])),(*reinterpret_cast< gboolean*(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4])));
            if (_a[0]) *reinterpret_cast< progdlg**>(_a[0]) = _r; }  break;
        ...
        {
            typedef void (ProgressFrame::*_t)(bool , bool , gboolean * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgressFrame::showRequested)) {
                *result = 0;
            }
        }
        {
            typedef void (ProgressFrame::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgressFrame::valueChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (ProgressFrame::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgressFrame::maximumValueChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (ProgressFrame::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgressFrame::setHidden)) {
                *result = 3;
            }
        }
        {
            typedef void (ProgressFrame::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgressFrame::stopLoading)) {
                *result = 4;
            }
        }
    }
...
const QMetaObject ProgressFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ProgressFrame.data,
      qt_meta_data_ProgressFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ProgressFrame.stringdata))
        return static_cast<void*>(const_cast< ProgressFrame*>(this));
