...
public:
    ...
    void setupUi(QDialog *FileSetDialog)
    {
        ...
        fileSetTree = new QTreeWidget(FileSetDialog);
    ...
    void retranslateUi(QDialog *FileSetDialog)
    {
        ...
        QTreeWidgetItem *___qtreewidgetitem = fileSetTree->headerItem();
        ___qtreewidgetitem->setText(3, QApplication::translate("FileSetDialog", "Size", 0));
        ___qtreewidgetitem->setText(2, QApplication::translate("FileSetDialog", "Modified", 0));
        ___qtreewidgetitem->setText(1, QApplication::translate("FileSetDialog", "Created", 0));
        ___qtreewidgetitem->setText(0, QApplication::translate("FileSetDialog", "Filename", 0));
    } // retranslateUi
