...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ExportPDUDialog_t, stringdata) + ofs \
...
void ExportPDUDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ExportPDUDialog *_t = static_cast<ExportPDUDialog *>(_o);
        switch (_id) {
...
const QMetaObject ExportPDUDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ExportPDUDialog.data,
      qt_meta_data_ExportPDUDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ExportPDUDialog.stringdata))
        return static_cast<void*>(const_cast< ExportPDUDialog*>(this));
