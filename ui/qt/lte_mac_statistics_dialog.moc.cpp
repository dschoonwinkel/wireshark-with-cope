...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_LteMacStatisticsDialog_t, stringdata) + ofs \
...
const QMetaObject LteMacStatisticsDialog::staticMetaObject = {
    { &TapParameterDialog::staticMetaObject, qt_meta_stringdata_LteMacStatisticsDialog.data,
      qt_meta_data_LteMacStatisticsDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LteMacStatisticsDialog.stringdata))
        return static_cast<void*>(const_cast< LteMacStatisticsDialog*>(this));
