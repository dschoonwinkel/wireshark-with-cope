...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PacketCommentDialog_t, stringdata) + ofs \
...
const QMetaObject PacketCommentDialog::staticMetaObject = {
    { &GeometryStateDialog::staticMetaObject, qt_meta_stringdata_PacketCommentDialog.data,
      qt_meta_data_PacketCommentDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PacketCommentDialog.stringdata))
