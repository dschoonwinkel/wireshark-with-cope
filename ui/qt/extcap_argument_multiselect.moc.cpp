...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ExtArgMultiSelect_t, stringdata) + ofs \
...
const QMetaObject ExtArgMultiSelect::staticMetaObject = {
    { &ExtcapArgument::staticMetaObject, qt_meta_stringdata_ExtArgMultiSelect.data,
      qt_meta_data_ExtArgMultiSelect,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ExtArgMultiSelect.stringdata))
        return static_cast<void*>(const_cast< ExtArgMultiSelect*>(this));
