...
public:
    ...
    void setupUi(QFrame *CapturePreferencesFrame)
    {
        ...
        CapturePreferencesFrame->resize(354, 194);
...
#endif // QT_NO_TOOLTIP
        capturePcapNgCheckBox->setText(QApplication::translate("CapturePreferencesFrame", "Capture packets in pcap-ng format", 0));
#ifndef QT_NO_TOOLTIP
