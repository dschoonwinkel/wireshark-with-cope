...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SCTPGraphArwndDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(11, 143, 21)
    },
    "SCTPGraphArwndDialog\0setCaptureFile\0"
    "\0_capture_file*\0cf\0on_pushButton_4_clicked\0"
...
const QMetaObject SCTPGraphArwndDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SCTPGraphArwndDialog.data,
      qt_meta_data_SCTPGraphArwndDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SCTPGraphArwndDialog.stringdata))
