...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FunnelStringDialog_t, stringdata) + ofs \
...
const QMetaObject FunnelStringDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FunnelStringDialog.data,
      qt_meta_data_FunnelStringDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FunnelStringDialog.stringdata))
        return static_cast<void*>(const_cast< FunnelStringDialog*>(this));
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_FunnelStringDialogHelper_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
void FunnelStringDialogHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FunnelStringDialogHelper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FunnelStringDialogHelper::closeDialogs)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject FunnelStringDialogHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FunnelStringDialogHelper.data,
      qt_meta_data_FunnelStringDialogHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FunnelStringDialogHelper.stringdata))
        return static_cast<void*>(const_cast< FunnelStringDialogHelper*>(this));
