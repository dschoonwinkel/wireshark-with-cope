...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CaptureInfoDialog_t, stringdata) + ofs \
...
const QMetaObject CaptureInfoDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CaptureInfoDialog.data,
      qt_meta_data_CaptureInfoDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CaptureInfoDialog.stringdata))
