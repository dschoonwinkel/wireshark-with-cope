...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SimpleStatisticsDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 32, 0)
    ...
    "SimpleStatisticsDialog\0fillTree\0\0"
};
...
const QMetaObject SimpleStatisticsDialog::staticMetaObject = {
    { &TapParameterDialog::staticMetaObject, qt_meta_stringdata_SimpleStatisticsDialog.data,
      qt_meta_data_SimpleStatisticsDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SimpleStatisticsDialog.stringdata))
        return static_cast<void*>(const_cast< SimpleStatisticsDialog*>(this));
