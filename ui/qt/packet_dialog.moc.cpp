...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PacketDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 71, 26)
    ...
    "PacketDialog\0monospaceFontChanged\0\0"
    "captureFileClosing\0setHintText\0hint\0"
...
void PacketDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->monospaceFontChanged((*reinterpret_cast< QFont(*)>(_a[1]))); break;
        case 1: _t->captureFileClosing(); break;
        case 2: _t->setHintText(); break;
        case 3: _t->setHintText((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (PacketDialog::*_t)(QFont );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PacketDialog::monospaceFontChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject PacketDialog::staticMetaObject = {
    { &WiresharkDialog::staticMetaObject, qt_meta_stringdata_PacketDialog.data,
      qt_meta_data_PacketDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PacketDialog.stringdata))
        return static_cast<void*>(const_cast< PacketDialog*>(this));
...
// SIGNAL 0
void PacketDialog::monospaceFontChanged(QFont _t1)
{
