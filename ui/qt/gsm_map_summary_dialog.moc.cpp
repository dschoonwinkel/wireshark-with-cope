...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GsmMapSummaryDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 34, 0)
    ...
    "GsmMapSummaryDialog\0updateWidgets\0\0"
};
...
const QMetaObject GsmMapSummaryDialog::staticMetaObject = {
    { &WiresharkDialog::staticMetaObject, qt_meta_stringdata_GsmMapSummaryDialog.data,
      qt_meta_data_GsmMapSummaryDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GsmMapSummaryDialog.stringdata))
        return static_cast<void*>(const_cast< GsmMapSummaryDialog*>(this));
