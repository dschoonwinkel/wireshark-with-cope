...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ExtcapArgument_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 58, 13)
    ...
    "onStringChanged\0onIntChanged\0onBoolChanged\0"
};
...
void ExtcapArgument::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ExtcapArgument::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ExtcapArgument::valueChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ExtcapArgument::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ExtcapArgument.data,
      qt_meta_data_ExtcapArgument,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ExtcapArgument.stringdata))
        return static_cast<void*>(const_cast< ExtcapArgument*>(this));
