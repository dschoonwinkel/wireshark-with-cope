...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AccordionFrame_t, stringdata) + ofs \
...
void AccordionFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (AccordionFrame::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AccordionFrame::visibilityChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject AccordionFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_AccordionFrame.data,
      qt_meta_data_AccordionFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AccordionFrame.stringdata))
        return static_cast<void*>(const_cast< AccordionFrame*>(this));
