...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FunnelTextDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 60, 7)
    ...
    "on_findLineEdit_textChanged\0pattern\0"
};
...
const QMetaObject FunnelTextDialog::staticMetaObject = {
    { &GeometryStateDialog::staticMetaObject, qt_meta_stringdata_FunnelTextDialog.data,
      qt_meta_data_FunnelTextDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FunnelTextDialog.stringdata))
        return static_cast<void*>(const_cast< FunnelTextDialog*>(this));
