...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SCTPAllAssocsDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 81, 2),
QT_MOC_LITERAL(8, 84, 24),
QT_MOC_LITERAL(9, 109, 26),
QT_MOC_LITERAL(10, 136, 15)
    ...
    "on_setFilterButton_clicked\0getSelectedItem\0"
};
...
void SCTPAllAssocsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SCTPAllAssocsDialog::*_t)(QString , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SCTPAllAssocsDialog::filterPackets)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject SCTPAllAssocsDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SCTPAllAssocsDialog.data,
      qt_meta_data_SCTPAllAssocsDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SCTPAllAssocsDialog.stringdata))
        return static_cast<void*>(const_cast< SCTPAllAssocsDialog*>(this));
