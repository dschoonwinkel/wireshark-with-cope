...
public:
    ...
    QButtonGroup *layoyutButtonGroup;
    ...
    void setupUi(QFrame *LayoutPreferencesFrame)
    {
        ...
        layoyutButtonGroup = new QButtonGroup(LayoutPreferencesFrame);
        layoyutButtonGroup->setObjectName(QStringLiteral("layoyutButtonGroup"));
        layoyutButtonGroup->addButton(layout5ToolButton);
        ...
        layoyutButtonGroup->addButton(layout2ToolButton);
        ...
        layoyutButtonGroup->addButton(layout1ToolButton);
        ...
        layoyutButtonGroup->addButton(layout4ToolButton);
        ...
        layoyutButtonGroup->addButton(layout3ToolButton);
        ...
        layoyutButtonGroup->addButton(layout6ToolButton);
    ...
    void retranslateUi(QFrame *LayoutPreferencesFrame)
    {
        ...
        packetListSeparatorCheckBox->setText(QApplication::translate("LayoutPreferencesFrame", "Show packet separator on Packet List", 0));
    } // retranslateUi
