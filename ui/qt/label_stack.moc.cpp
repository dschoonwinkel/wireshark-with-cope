...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_LabelStack_t, stringdata) + ofs \
...
void LabelStack::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (LabelStack::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LabelStack::toggleTemporaryFlash)) {
                *result = 0;
            }
        }
        {
            typedef void (LabelStack::*_t)(const QPoint & , Qt::MouseButton );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LabelStack::mousePressedAt)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject LabelStack::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_LabelStack.data,
      qt_meta_data_LabelStack,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LabelStack.stringdata))
        return static_cast<void*>(const_cast< LabelStack*>(this));
