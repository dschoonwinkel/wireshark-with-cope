...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RtpPlayerDialog_t, stringdata) + ofs \
...
const QMetaObject RtpPlayerDialog::staticMetaObject = {
    { &WiresharkDialog::staticMetaObject, qt_meta_stringdata_RtpPlayerDialog.data,
      qt_meta_data_RtpPlayerDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RtpPlayerDialog.stringdata))
        return static_cast<void*>(const_cast< RtpPlayerDialog*>(this));
