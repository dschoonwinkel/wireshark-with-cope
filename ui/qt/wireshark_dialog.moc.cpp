...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WiresharkDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 70, 17)
    ...
    "WiresharkDialog\0beginRetapPackets\0\0"
    "endRetapPackets\0captureFileClosing\0"
    "captureFileClosed\0"
};
...
void WiresharkDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->beginRetapPackets(); break;
        case 1: _t->endRetapPackets(); break;
        case 2: _t->captureFileClosing(); break;
        case 3: _t->captureFileClosed(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject WiresharkDialog::staticMetaObject = {
    { &GeometryStateDialog::staticMetaObject, qt_meta_stringdata_WiresharkDialog.data,
      qt_meta_data_WiresharkDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WiresharkDialog.stringdata))
        return static_cast<void*>(const_cast< WiresharkDialog*>(this));
