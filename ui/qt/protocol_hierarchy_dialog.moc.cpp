...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ProtocolHierarchyDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 73, 24),
QT_MOC_LITERAL(7, 98, 4),
QT_MOC_LITERAL(8, 103, 17),
QT_MOC_LITERAL(9, 121, 3),
QT_MOC_LITERAL(10, 125, 21),
QT_MOC_LITERAL(11, 147, 28),
...
void ProtocolHierarchyDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ProtocolHierarchyDialog::*_t)(QString , FilterAction::Action , FilterAction::ActionType );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProtocolHierarchyDialog::filterAction)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ProtocolHierarchyDialog::staticMetaObject = {
    { &WiresharkDialog::staticMetaObject, qt_meta_stringdata_ProtocolHierarchyDialog.data,
      qt_meta_data_ProtocolHierarchyDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ProtocolHierarchyDialog.stringdata))
        return static_cast<void*>(const_cast< ProtocolHierarchyDialog*>(this));
