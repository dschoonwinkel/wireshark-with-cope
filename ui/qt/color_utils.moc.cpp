...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ColorUtils_t, stringdata) + ofs \
...
const QMetaObject ColorUtils::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ColorUtils.data,
      qt_meta_data_ColorUtils,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ColorUtils.stringdata))
        return static_cast<void*>(const_cast< ColorUtils*>(this));
