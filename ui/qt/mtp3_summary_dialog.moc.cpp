...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Mtp3SummaryDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 32, 0)
    ...
    "Mtp3SummaryDialog\0updateWidgets\0\0"
};
...
const QMetaObject Mtp3SummaryDialog::staticMetaObject = {
    { &WiresharkDialog::staticMetaObject, qt_meta_stringdata_Mtp3SummaryDialog.data,
      qt_meta_data_Mtp3SummaryDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Mtp3SummaryDialog.stringdata))
