...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ConversationAction_t, stringdata) + ofs \
...
const QMetaObject ConversationAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_ConversationAction.data,
      qt_meta_data_ConversationAction,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ConversationAction.stringdata))
        return static_cast<void*>(const_cast< ConversationAction*>(this));
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ColorizeAction_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject ColorizeAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_ColorizeAction.data,
      qt_meta_data_ColorizeAction,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ColorizeAction.stringdata))
        return static_cast<void*>(const_cast< ColorizeAction*>(this));
    return QAction::qt_metacast(_clname);
}
