/****************************************************************************
** Meta object code from reading C++ file 'elided_label.h'
**
...
#error "The header file 'elided_label.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ElidedLabel_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 27, 4)
    ...
    "ElidedLabel\0clear\0\0setText\0text\0"
};
...
const QMetaObject ElidedLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_ElidedLabel.data,
      qt_meta_data_ElidedLabel,  qt_static_metacall, 0, 0}
};
