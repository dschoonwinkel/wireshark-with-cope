...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DisplayFilterCombo_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 58, 14)
    },
    "DisplayFilterCombo\0checkDisplayFilter\0"
    "\0applyDisplayFilter\0updateMaxCount\0"
};
...
void DisplayFilterCombo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->updateMaxCount(); break;
        default: ;
        }
    }
}
...
const QMetaObject DisplayFilterCombo::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_DisplayFilterCombo.data,
      qt_meta_data_DisplayFilterCombo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DisplayFilterCombo.stringdata))
        return static_cast<void*>(const_cast< DisplayFilterCombo*>(this));
