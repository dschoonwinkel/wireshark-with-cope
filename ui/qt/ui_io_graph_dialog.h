...
public:
    ...
    void setupUi(QDialog *IOGraphDialog)
    {
        ...
        graphTreeWidget = new QTreeWidget(IOGraphDialog);
        graphTreeWidget->setObjectName(QStringLiteral("graphTreeWidget"));
        QSizePolicy sizePolicy1(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(1);
        sizePolicy1.setHeightForWidth(graphTreeWidget->sizePolicy().hasHeightForWidth());
        graphTreeWidget->setSizePolicy(sizePolicy1);

        verticalLayout->addWidget(graphTreeWidget);
...
"</body></html>", 0));
        ...
        QTreeWidgetItem *___qtreewidgetitem = graphTreeWidget->headerItem();
        ___qtreewidgetitem->setText(6, QApplication::translate("IOGraphDialog", "Smoothing", 0));
        ___qtreewidgetitem->setText(5, QApplication::translate("IOGraphDialog", "Y Field", 0));
        ___qtreewidgetitem->setText(4, QApplication::translate("IOGraphDialog", "Y Axis", 0));
        ___qtreewidgetitem->setText(3, QApplication::translate("IOGraphDialog", "Style", 0));
        ___qtreewidgetitem->setText(2, QApplication::translate("IOGraphDialog", "Color", 0));
        ___qtreewidgetitem->setText(1, QApplication::translate("IOGraphDialog", "Display filter", 0));
        ___qtreewidgetitem->setText(0, QApplication::translate("IOGraphDialog", "Name", 0));
#ifndef QT_NO_TOOLTIP
