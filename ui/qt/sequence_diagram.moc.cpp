...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SequenceDiagram_t, stringdata) + ofs \
...
const QMetaObject SequenceDiagram::staticMetaObject = {
    { &QCPAbstractPlottable::staticMetaObject, qt_meta_stringdata_SequenceDiagram.data,
      qt_meta_data_SequenceDiagram,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SequenceDiagram.stringdata))
        return static_cast<void*>(const_cast< SequenceDiagram*>(this));
