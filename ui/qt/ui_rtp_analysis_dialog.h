...
public:
    ...
    void setupUi(QDialog *RtpAnalysisDialog)
    {
        ...
        actionSaveAudio = new QAction(RtpAnalysisDialog);
        actionSaveAudio->setObjectName(QStringLiteral("actionSaveAudio"));
        actionSaveForwardAudio = new QAction(RtpAnalysisDialog);
        actionSaveForwardAudio->setObjectName(QStringLiteral("actionSaveForwardAudio"));
        actionSaveReverseAudio = new QAction(RtpAnalysisDialog);
    ...
    void retranslateUi(QDialog *RtpAnalysisDialog)
    {
        ...
        actionSaveAudio->setText(QApplication::translate("RtpAnalysisDialog", "Audio", 0));
#ifndef QT_NO_TOOLTIP
        actionSaveAudio->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the audio data for both channels.", 0));
#endif // QT_NO_TOOLTIP
        actionSaveForwardAudio->setText(QApplication::translate("RtpAnalysisDialog", "Forward Stream Audio", 0));
#ifndef QT_NO_TOOLTIP
        actionSaveForwardAudio->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the forward stream audio data.", 0));
#endif // QT_NO_TOOLTIP
        actionSaveReverseAudio->setText(QApplication::translate("RtpAnalysisDialog", "Reverse Stream Audio", 0));
#ifndef QT_NO_TOOLTIP
        actionSaveReverseAudio->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the reverse stream audio data.", 0));
#endif // QT_NO_TOOLTIP
