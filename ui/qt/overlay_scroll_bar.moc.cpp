...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_OverlayScrollBar_t, stringdata) + ofs \
...
const QMetaObject OverlayScrollBar::staticMetaObject = {
    { &QScrollBar::staticMetaObject, qt_meta_stringdata_OverlayScrollBar.data,
      qt_meta_data_OverlayScrollBar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OverlayScrollBar.stringdata))
        return static_cast<void*>(const_cast< OverlayScrollBar*>(this));
