...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CaptureFilterEdit_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 91, 5),
QT_MOC_LITERAL(6, 97, 12),
QT_MOC_LITERAL(7, 110, 11),
QT_MOC_LITERAL(8, 122, 6),
QT_MOC_LITERAL(9, 129, 11),
QT_MOC_LITERAL(10, 141, 18),
QT_MOC_LITERAL(11, 160, 10),
QT_MOC_LITERAL(12, 171, 12),
QT_MOC_LITERAL(13, 184, 11),
QT_MOC_LITERAL(14, 196, 13),
QT_MOC_LITERAL(15, 210, 18),
QT_MOC_LITERAL(16, 229, 20),
QT_MOC_LITERAL(17, 250, 5),
QT_MOC_LITERAL(18, 256, 7),
QT_MOC_LITERAL(19, 264, 15),
QT_MOC_LITERAL(20, 280, 11)
    },
    ...
    "bookmarkClicked\0clearFilter\0"
};
...
void CaptureFilterEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CaptureFilterEdit::pushFilterSyntaxStatus)) {
                *result = 0;
            }
        }
        {
            typedef void (CaptureFilterEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CaptureFilterEdit::popFilterSyntaxStatus)) {
                *result = 1;
            }
        }
        {
            typedef void (CaptureFilterEdit::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CaptureFilterEdit::captureFilterSyntaxChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (CaptureFilterEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CaptureFilterEdit::startCapture)) {
                *result = 3;
            }
        }
        {
            typedef void (CaptureFilterEdit::*_t)(const QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CaptureFilterEdit::addBookmark)) {
                *result = 4;
            }
        }
    }
...
const QMetaObject CaptureFilterEdit::staticMetaObject = {
    { &SyntaxLineEdit::staticMetaObject, qt_meta_stringdata_CaptureFilterEdit.data,
      qt_meta_data_CaptureFilterEdit,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CaptureFilterEdit.stringdata))
        return static_cast<void*>(const_cast< CaptureFilterEdit*>(this));
