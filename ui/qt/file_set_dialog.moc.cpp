...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FileSetDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 99, 16),
QT_MOC_LITERAL(6, 116, 7),
QT_MOC_LITERAL(7, 124, 8)
    },
    "FileSetDialog\0fileSetOpenCaptureFile\0"
    "\0on_buttonBox_helpRequested\0"
    "on_fileSetTree_currentItemChanged\0"
...
void FileSetDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_fileSetTree_currentItemChanged((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< QTreeWidgetItem*(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (FileSetDialog::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileSetDialog::fileSetOpenCaptureFile)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject FileSetDialog::staticMetaObject = {
    { &GeometryStateDialog::staticMetaObject, qt_meta_stringdata_FileSetDialog.data,
      qt_meta_data_FileSetDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FileSetDialog.stringdata))
        return static_cast<void*>(const_cast< FileSetDialog*>(this));
