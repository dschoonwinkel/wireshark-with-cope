...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ExportObjectDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 32, 18),
QT_MOC_LITERAL(5, 51, 26),
QT_MOC_LITERAL(6, 78, 32),
QT_MOC_LITERAL(7, 111, 16),
QT_MOC_LITERAL(8, 128, 4),
QT_MOC_LITERAL(9, 133, 8),
QT_MOC_LITERAL(10, 142, 20),
QT_MOC_LITERAL(11, 163, 16),
QT_MOC_LITERAL(12, 180, 6)
    },
    "ExportObjectDialog\0show\0\0accept\0"
    "captureFileClosing\0on_buttonBox_helpRequested\0"
    "on_objectTree_currentItemChanged\0"
    "QTreeWidgetItem*\0item\0previous\0"
...
void ExportObjectDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->on_objectTree_currentItemChanged((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< QTreeWidgetItem*(*)>(_a[2]))); break;
...
const QMetaObject ExportObjectDialog::staticMetaObject = {
    { &WiresharkDialog::staticMetaObject, qt_meta_stringdata_ExportObjectDialog.data,
      qt_meta_data_ExportObjectDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ExportObjectDialog.stringdata))
        return static_cast<void*>(const_cast< ExportObjectDialog*>(this));
