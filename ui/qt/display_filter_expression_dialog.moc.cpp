...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DisplayFilterExpressionDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 30, 19),
QT_MOC_LITERAL(2, 50, 0),
QT_MOC_LITERAL(3, 51, 6),
QT_MOC_LITERAL(4, 58, 8),
QT_MOC_LITERAL(5, 67, 13),
QT_MOC_LITERAL(6, 81, 39),
QT_MOC_LITERAL(7, 121, 42),
QT_MOC_LITERAL(8, 164, 38),
QT_MOC_LITERAL(9, 203, 29),
QT_MOC_LITERAL(10, 233, 9),
QT_MOC_LITERAL(11, 243, 21),
QT_MOC_LITERAL(12, 265, 26)
    },
...
void DisplayFilterExpressionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DisplayFilterExpressionDialog::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DisplayFilterExpressionDialog::insertDisplayFilter)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DisplayFilterExpressionDialog::staticMetaObject = {
    { &GeometryStateDialog::staticMetaObject, qt_meta_stringdata_DisplayFilterExpressionDialog.data,
      qt_meta_data_DisplayFilterExpressionDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DisplayFilterExpressionDialog.stringdata))
        return static_cast<void*>(const_cast< DisplayFilterExpressionDialog*>(this));
