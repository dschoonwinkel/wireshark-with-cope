...
Michael TE<uuml>xen           <tuexen[AT]wireshark.org> 
...
Irene RE<uuml>ngeler		<ruengeler[AT]wireshark.org> 
...
Nils O. SelE<aring>sdal	<noselasd[AT]asgaard.homelinux.org> 
...
Stig BjE<oslash>rlykke		<stig[AT]bjorlykke.org> 
...
ME<ocirc>she van der Sterre	<moshevds[AT]gmail.com> 
...
Jens BrE<auml>uer		<jensb[AT]cs.tu-berlin.de> 
...
Hannes KE<auml>lber		<hannes.kaelber--wireshark[AT]x2e.de> 
...
Joan RamiE<oacute>		<joan[AT]ramio.cat> 
...
Bruno PrE<eacute>mont		<bonbons[AT]linux-vserver.org> 
...
Richard KE<uuml>mmel		<r.kuemmel[AT]beckhoff.de> 
...
HE<aring>kon NessjE<oslash>en		<haakon.nessjoen[AT]gmail.com> 
Herbert Lischka		<herbert[AT]lischka-berlin.de> 
Felix KrE<auml>mer		<sauter-cumulus[AT]de.sauter-bc.com> 
...
Toralf FE<ouml>rster		<toralf.foerster[AT]gmx.de> 
StE<eacute>phane Bryant		<stephane[AT]glycon.org> 
Emil Wojak		<emil[AT]wojak.eu> 
Steve Huston		<shuston[AT]riverace.com> 
LorE<aacute>nd Jakab		<ljakab[AT]ac.upc.edu> 
...
Mariusz OkrE<oacute>j		<okrojmariusz[AT]gmail.com> 
...
RaphaE<euml>l Doursenaud	<rdoursenaud[AT]free.fr> 
...
Marc PoulhiE<egrave>s		<marc.poulhies[AT]epfl.ch>
...
Peter KovE<aacute>ř		<peter.kovar[AT]gmail.com>
...
Martin AndrE<eacute>		<andre[AT]clarinet.u-strasbg.fr>
...
Diego PettenE<ograve>		<flameeyes[AT]gentoo.org>
...
StE<eacute>phane Loeuillet	<leroutier[AT]gmail.com>
Andrei Rubaniuk		<rubaniuk[AT]mail.ru>
Mikael Magnusson	<mikma264[AT]gmail.com>
Timo TerE<auml>s		<timo.teras[AT]iki.fi>
ME<aacute>rton NE<eacute>meth		<nm127[AT]freemail.hu>
...
Magnus SE<ouml>rman		<magnus.sorman[AT]ericsson.com>
...
JoE<atilde>o Valverde		<joao.valverde[AT]tecnico.ulisboa.pt>
BenoE<icirc>t Canet		<benoit[AT]scylladb.com>
...
Alexander GE<auml>rtner	<sphinxs1988[AT]googlemail.com>
...
Cenk GE<uuml>ndoğan		<cnkgndgn[AT]gmail.com>
...
Ignacio MartE<iacute>nez	<ignacio.martinez.rivera[AT]gmail.com>
...
JE<eacute>rE<ocirc>me LAFORGE		<jerome.laforge[AT]gmail.com>
...
Lars SundstrE<ouml>m		<lars.x.sundstrom[AT]ericsson.com>
...
LE<eacute>o Gaspard		<leo[AT]gaspard.io>
...
Martin TibenskE<yacute>		<martin.tibensky[AT]alcatel-lucent.com>
Martin Vit		<martin[AT]voipmonitor.org>
Matej KošE<iacute>k		<5764c029b688c1c0d24a2e97cd764f[AT]gmail.com>
...
Michal PrE<iacute>voznE<iacute>k	<mprivozn[AT]redhat.com>
...
Paulo Roberto BrandE<atilde>o	<betobrandao[AT]gmail.com>
...
Stefan PE<ouml>schel		<github[AT]basicmaster.de>
Stefan VE<ouml>lkel		<sv[AT]its-v.de>
...
Ville SkyttE<auml>		<ville.skytta[AT]iki.fi>
...
Zdeněk ŽamberskE<yacute>	<zzdevel[AT]seznam.cz>
...
E<Eacute>ric Piel		<piel[AT]delmic.com>
E<Oslash>yvind RE<oslash>nningstad	<ronningstad[AT]gmail.com>
